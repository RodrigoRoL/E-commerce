...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: "Products cant be founds"});
  }
});
...
router.get('/:id', async (req, res) => {
  ...
  try {
    ...
    !product ? res.status(404).json({ message: "Product cant be found"}) : res.status(200).json(product);
  } catch (err) {
    res.status(500).json({ message: "Proudct cant be found"});
  }
});
...
router.delete('/:id', async (req, res) => {
  ...
  try {
    ...
    !deleted ? res.status(404).json({ message: "Id cant be found"}) : res.status(200).json(deleted);
  } catch (err) {
